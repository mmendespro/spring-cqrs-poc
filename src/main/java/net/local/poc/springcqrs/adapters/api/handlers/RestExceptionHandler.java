package net.local.poc.springcqrs.adapters.api.handlers;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<Object> onBookAlreadyExistException(BookAlreadyExistException exception) {
        var errors = List.of(new FieldValidationError("title", exception.getMessage())); 
        return getResponseEntity(INVALID_FIELD_MESSAGE, errors, BAD_REQUEST);
    }
